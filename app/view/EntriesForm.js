...
Ext.define('Phonebook.view.EntriesForm', {
    ...
    items: [{
        ...
        layout: 'fit',
        border: 'none',
        defaults: {xtype: 'textfield', allowBlank: false, margin: '0 0 5 0', afterLabelTextTpl: '<span style="color:red;font-weight:bold" data-qtip="Required">*</span>', maxLength: 255, enforceMaxLength: true},
        items: [{
            name: 'firstname',
